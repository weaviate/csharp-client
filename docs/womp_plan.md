# Weaviate.Client.Womp - Implementation Plan
...
src/
  ...
  Weaviate.Client.Womp/                # NEW - All WOMP code
    ├── Attributes/
...
**File:** `src/Weaviate.Client.Womp/Weaviate.Client.Womp.csproj`
...
**File:** `src/Weaviate.Client.Womp/Attributes/WeaviateCollectionAttribute.cs`
...
**File:** `src/Weaviate.Client.Womp/Attributes/InvertedIndexAttribute.cs`
...
**File:** `src/Weaviate.Client.Womp/Attributes/PropertyAttribute.cs`
...
**File:** `src/Weaviate.Client.Womp/Attributes/IndexAttribute.cs`
...
**File:** `src/Weaviate.Client.Womp/Attributes/TokenizationAttribute.cs`
...
**File:** `src/Weaviate.Client.Womp/Attributes/VectorAttribute.cs`
...
**File:** `src/Weaviate.Client.Womp/Attributes/VectorIndexAttribute.cs`
...
**File:** `src/Weaviate.Client.Womp/Attributes/ReferenceAttribute.cs`
...
**File:** `src/Weaviate.Client.Womp/Attributes/NestedTypeAttribute.cs`
...
**File:** `src/Weaviate.Client.Womp/Internal/PropertyHelper.cs`
...
**File:** `src/Weaviate.Client.Womp/Schema/CollectionSchemaBuilder.cs`
...
**File:** `src/Weaviate.Client.Womp/Schema/VectorConfigBuilder.cs`
...
**File:** `src/Weaviate.Client.Womp/Query/ExpressionToFilterConverter.cs`
...
**File:** `src/Weaviate.Client.Womp/Query/WompQueryClient.cs`
...
**File:** `src/Weaviate.Client.Womp/Mapping/WompObjectMapper.cs`
...
**File:** `src/Weaviate.Client.Womp/Mapping/VectorMapper.cs`
...
**File:** `src/Weaviate.Client.Womp/Mapping/ReferenceMapper.cs`
...
**File:** `src/Weaviate.Client.Womp/Extensions/WeaviateClientExtensions.cs`
...
**File:** `src/Weaviate.Client.Womp/Extensions/CollectionClientExtensions.cs`
...
public static class CollectionClientExtensions
{
    ...
    /// </summary>
    public static WompQueryClient<T> Query<T>(
    ...
    public static async Task<Guid> Insert<T>(
        ...
        where T : class
    {
        var weaviateObj = WompObjectMapper.ToWeaviateObject(obj);
...
**File:** `src/Weaviate.Client.Womp/README.md`
...
**File:** `src/Weaviate.Client.Womp.Examples/Program.cs`
...
### Unit Tests
**Project:** `src/Weaviate.Client.Womp.Tests/`
...
### Integration Tests
**Project:** `src/Weaviate.Client.Tests.Integration/Womp/`
...
1. ✅ Create `Weaviate.Client.Womp.csproj`
...
7. ✅ Implement `WompQueryClient`
8. ✅ Implement `WompObjectMapper`
