# Weaviate.Client.Orm - Implementation Plan

## Overview

This document outlines the complete implementation plan for the Weaviate C# ORM layer. The ORM provides a declarative, attribute-based approach to defining collection schemas and type-safe LINQ-style query capabilities.
...
src/
  ...
  Weaviate.Client.Orm/                # NEW - All ORM code
    ├── Attributes/
...
**File:** `src/Weaviate.Client.Orm/Weaviate.Client.Orm.csproj`
...
**File:** `src/Weaviate.Client.Orm/Attributes/WeaviateCollectionAttribute.cs`
...
**File:** `src/Weaviate.Client.Orm/Attributes/InvertedIndexAttribute.cs`
...
**File:** `src/Weaviate.Client.Orm/Attributes/PropertyAttribute.cs`
...
**File:** `src/Weaviate.Client.Orm/Attributes/IndexAttribute.cs`
...
**File:** `src/Weaviate.Client.Orm/Attributes/TokenizationAttribute.cs`
...
**File:** `src/Weaviate.Client.Orm/Attributes/VectorAttribute.cs`
...
**File:** `src/Weaviate.Client.Orm/Attributes/VectorIndexAttribute.cs`
...
**File:** `src/Weaviate.Client.Orm/Attributes/ReferenceAttribute.cs`
...
**File:** `src/Weaviate.Client.Orm/Attributes/NestedTypeAttribute.cs`
...
**File:** `src/Weaviate.Client.Orm/Internal/PropertyHelper.cs`
...
**File:** `src/Weaviate.Client.Orm/Schema/CollectionSchemaBuilder.cs`
...
**File:** `src/Weaviate.Client.Orm/Schema/VectorConfigBuilder.cs`
...
**File:** `src/Weaviate.Client.Orm/Query/ExpressionToFilterConverter.cs`
...
#### Step 3.2: ORM Query Client
**File:** `src/Weaviate.Client.Orm/Query/OrmQueryClient.cs`
...
#### Step 4.1: ORM Object Mapper
**File:** `src/Weaviate.Client.Orm/Mapping/OrmObjectMapper.cs`
...
**File:** `src/Weaviate.Client.Orm/Mapping/VectorMapper.cs`
...
**File:** `src/Weaviate.Client.Orm/Mapping/ReferenceMapper.cs`
...
**File:** `src/Weaviate.Client.Orm/Extensions/WeaviateClientExtensions.cs`
...
**File:** `src/Weaviate.Client.Orm/Extensions/CollectionClientExtensions.cs`

```csharp
public static class CollectionClientExtensions
{
    /// <summary>
    /// Get ORM query client for type-safe queries
    /// </summary>
    public static OrmQueryClient<T> Query<T>(
        this CollectionClient collection)
        where T : class, new()
    {
        return new OrmQueryClient<T>(collection);
    }
    ...
    public static async Task<Guid> Insert<T>(
        ...
        where T : class
    {
        var weaviateObj = OrmObjectMapper.ToWeaviateObject(obj);
...
**File:** `src/Weaviate.Client.Orm/README.md`
...
**File:** `src/Weaviate.Client.Orm.Examples/Program.cs`
...
### Unit Tests
**Project:** `src/Weaviate.Client.Orm.Tests/`
...
### Integration Tests
**Project:** `src/Weaviate.Client.Tests.Integration/Orm/`
...
1. ✅ Create `Weaviate.Client.Orm.csproj`
...
7. ✅ Implement `OrmQueryClient`
8. ✅ Implement `OrmObjectMapper`
...
6. **Batch Operations** - Bulk insert with ORM
7. **Change Tracking** - Update only modified properties
8. **Lazy Loading** - Lazy reference loading

## Notes

- Keep all ORM code in separate namespace to avoid pollution
