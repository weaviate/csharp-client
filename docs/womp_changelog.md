# Weaviate.Client.Womp - Development Changelog
...
- **Location:** WompQueryClient.cs:184
...
- **Location:** WompQueryClient.cs:312
...
**Decision:** Create `Weaviate.Client.Womp` as a separate project/package
**Rationale:**
...
- Wrappers: `WompQueryClient<T>` wraps `TypedQueryClient<T>`
...
**Next Steps:**
1. Create `Weaviate.Client.Womp` project structure
...
**Files Created:**
1. **Project Structure**
   - `src/Weaviate.Client.Womp/Weaviate.Client.Womp.csproj` - Project file with Humanizer.Core dependency
