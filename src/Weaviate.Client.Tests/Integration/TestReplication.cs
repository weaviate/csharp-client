...
public class TestReplication : IntegrationTests
{
    ...
    /// <inheritdoc />
    public override string RestHost => _configuration.GetValue<string>("WV_TEST_CLUSTER_HOST") ?? "localhost";

    /// <summary>
    /// Gets the value of the rest port
    /// </summary>
    public override ushort RestPort => _configuration.GetValue<ushort>("WV_TEST_CLUSTER_REST_PORT", 8087);

    /// <summary>
    /// Gets the value of the grpc port
    /// </summary>
    public override ushort GrpcPort => _configuration.GetValue<ushort>("WV_TEST_CLUSTER_GRPC_PORT", 50058);
