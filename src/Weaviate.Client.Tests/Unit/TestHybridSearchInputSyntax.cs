...
public class TestHybridSearchInputSyntax
{
    ...
    private static Task VersionedTest(Func<CollectionClient, Func<V1.SearchRequest?>, Task> test) =>
        Task.WhenAll(
            TestedVersions.Select(async version =>
            {
                var (client, getRequest) = MockGrpcClient.CreateWithSearchCapture(version);
                var collection = client.Collections.Use(CollectionName);
                await test(collection, getRequest);
            })
        );
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_QueryOnly_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Act
                ...
                if (collection.Client.WeaviateVersion < new Version(1, 35, 0))
                {
                    Assert.Equal(0.7f, request.HybridSearch.Alpha, precision: 5); // Default alpha
                }
                else if (collection.Client.WeaviateVersion >= new Version(1, 36, 0))
                {
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_QueryOnly_WithAlpha_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Act
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_QueryOnly_WithFusionType_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Act
                ...
                Assert.NotNull(request);
                Assert.Equal(
                    V1.Hybrid.Types.FusionType.RelativeScore,
                    request.HybridSearch.FusionType
                );
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_VectorSearchInput_FloatArray_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_VectorSearchInput_DoubleArray_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_VectorSearchInput_NamedTuple_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_VectorSearchInput_NamedTuple_Double_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_VectorSearchInput_MultiVector_Float2D_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_VectorSearchInput_MultiVector_Double2D_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_VectorSearchInput_NamedVector_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_VectorSearchInput_Vectors_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_VectorSearchInput_Builder_Sum_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_VectorSearchInput_Builder_Average_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
                ...
                Assert.NotNull(request);
                Assert.Equal(
                    V1.CombinationMethod.TypeAverage,
                    request.HybridSearch.Targets.Combination
                );
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_VectorSearchInput_Builder_Minimum_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_VectorSearchInput_Builder_ManualWeights_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
                ...
                Assert.NotNull(request);
                Assert.Equal(
                    V1.CombinationMethod.TypeManual,
                    request.HybridSearch.Targets.Combination
                );
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_VectorSearchInput_Builder_RelativeScore_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_VectorSearchInput_Builder_SameNameSum_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_NearTextInput_String_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_NearTextInput_Explicit_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_NearTextInput_WithCertainty_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_NearTextInput_WithTargetVectors_Sum_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_NearTextInput_WithTargetVectors_Average_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_NearTextInput_WithTargetVectors_Minimum_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_NearTextInput_WithTargetVectors_ManualWeights_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_NearTextInput_WithTargetVectors_RelativeScore_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_NearTextInput_WithLambdaBuilder_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_NearTextInput_SimpleString_FromDocs_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_NearVectorInput_Basic_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_NearVectorInput_WithDistance_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_NearVectorInput_WithCertainty_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_NearVectorInput_Named_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_NearVectorInput_MultiTarget_Sum_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_NearVectorInput_MultiTarget_ManualWeights_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_NearVectorInput_WithCertainty_FromDocs_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_NearVectorInput_MultiTarget_FromDocs_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_QueryAndVectorSearchInput_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Act
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_QueryAndNearText_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_QueryAndNearVector_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_QueryAndMultiTargetVectors_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_VectorSearchInput_Combine_WithTuples_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_VectorSearchInput_Combine_WithVectors_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_VectorSearchInput_Combine_WithWeights_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_LambdaBuilder_Sum_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_LambdaBuilder_ManualWeights_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_LambdaBuilder_Average_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Act
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_NullQueryAndNullVectors_ThrowsArgumentException() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Act & Assert
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_ImplicitConversion_Vector_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_ImplicitConversion_TargetVectorsArray_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_ImplicitConversion_String_ToNearText_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_ImplicitConversion_NamedVectorArray_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_ImplicitConversion_NearTextInput_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_ImplicitConversion_NearVectorInput_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_ImplicitConversion_VectorSearchInput_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_DictionaryStringFloatArray_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_DictionaryStringDoubleArray_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_DictionaryStringVectorArray_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_DictionaryStringFloat2D_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_DictionaryStringDouble2D_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange - 2D arrays for ColBERT multi-vector
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_DictionaryStringEnumerableFloatArray_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_DictionaryStringEnumerableDoubleArray_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_DictionaryStringEnumerableFloat2D_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_DictionaryStringEnumerableDouble2D_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_FactoryFn_Sum_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_FactoryFn_Average_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Act - using FactoryFn implicit conversion
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_FactoryFn_Minimum_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Act - using FactoryFn implicit conversion
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_FactoryFn_ManualWeights_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Act - using FactoryFn implicit conversion
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_FactoryFn_RelativeScore_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Act - using FactoryFn implicit conversion
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_TargetVectors_Sum_ViaLambda_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                ...
                var nearText = new NearTextInput(
                    "query",
                    TargetVectors: t => t.Sum("vec1", "vec2")
                );
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_TargetVectors_Average_ViaLambda_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Act
                var nearText = new NearTextInput(
                    "query",
                    TargetVectors: t => t.Average("vec1", "vec2")
                );
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_TargetVectors_Minimum_ViaLambda_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Act
                var nearText = new NearTextInput(
                    "query",
                    TargetVectors: t => t.Minimum("vec1", "vec2")
                );
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_TargetVectors_ManualWeights_ViaLambda_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Act
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_TargetVectors_RelativeScore_ViaLambda_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Act
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_CollectionInitializer_SingleVector_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_CollectionInitializer_MultipleVectors_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_CollectionInitializer_MultipleVectorsSameName_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_CollectionInitializer_WithVectorsObject_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_NearVectorInput_MultiTarget_Average_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_NearVectorInput_MultiTarget_Minimum_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_NearVectorInput_MultiTarget_RelativeScore_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Arrange
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_NearVectorInput_FromVectorSearchInput_Implicit_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_HybridNearTextInputBuilder_NearText_NoMethod_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                ...
                Assert.NotNull(request.HybridSearch.NearText);
                Assert.Equal(
                    V1.CombinationMethod.Unspecified,
                    request.HybridSearch.Targets.Combination
                );
    ...
    public Task Extras() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                ...
                var queryNearVector3 = await collection.Query.Hybrid(
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_HybridVectorInputBuilder_NearVector_ManualWeights_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
                // Act - using HybridVectorInput.FactoryFn with NearVector().ManualWeights()
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_HybridVectorInputBuilder_NearVector_Sum_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_HybridVectorInputBuilder_NearVector_WithManualWeights_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_HybridVectorInputBuilder_NearText_ManualWeights_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_HybridVectorInputBuilder_NearText_Average_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_HybridVectorInputBuilder_NearText_WithCertaintyAndMove_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_HybridVectorInputBuilder_Vectors_DirectSyntax_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
    ...
    /// </summary>
    [Fact]
    public Task Hybrid_NearTextBuilder_FromDocs_ProducesValidRequest() =>
        VersionedTest(
            async (collection, getRequest) =>
            {
