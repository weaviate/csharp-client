...
## Query Builder API (WompQueryClient)

The `WompQueryClient<T>` provides a fluent, type-safe API for building Weaviate queries. Access it via `collection.Query<T>()`. All methods are chainable.
