    ...
    where T : class, new()
{
    ...
    internal OrmQueryClient(CollectionClient collection)
    {
    ...
    /// </code>
    /// </example>
    public OrmQueryClient<T> Where(Expression<Func<T, bool>> predicate)
    {
    ...
    /// <returns>The query builder for chaining.</returns>
    public OrmQueryClient<T> NearText(
        string text,
    ...
    /// <param name="distance">Maximum distance threshold.</param>
    /// <returns>The query builder for chaining.</returns>
    public OrmQueryClient<T> NearVector(
        float[] vectorValues,
        Expression<Func<T, object>>? vector = null,
        float? certainty = null,
        float? distance = null
    ...
    /// <returns>The query builder for chaining.</returns>
    public OrmQueryClient<T> Hybrid(
        string query,
        Expression<Func<T, object>>? vector = null,
        float? alpha = null
    )
    ...
    /// <returns>The query builder for chaining.</returns>
    public OrmQueryClient<T> Limit(uint limit)
    {
        _limit = limit;
        return this;
    }
    ...
    /// <returns>The query builder for chaining.</returns>
    public OrmQueryClient<T> Sort<TProp>(
    ...
    /// </code>
    /// </example>
    public OrmQueryClient<T> WithVectors(params Expression<Func<T, object>>[] vectors)
    {
    ...
    /// </code>
    /// </example>
    public OrmQueryClient<T> WithReferences(params Expression<Func<T, object>>[] references)
    {
    ...
    /// <returns>The query builder for chaining.</returns>
    public OrmQueryClient<T> Select(Expression<Func<T, object>> selector)
    {
    ...
    /// <returns>The query builder for chaining.</returns>
    public OrmQueryClient<T> WithMetadata(MetadataQuery metadata)
    {
