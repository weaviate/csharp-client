...
internal partial class WeaviateRestClient
{
    ...
    /// </summary>
    internal async Task CancelReplicationAsync(Guid id)
    {
    ...
    /// </summary>
    internal async Task DeleteReplicationAsync(Guid id)
    {
        var response = await _httpClient.DeleteAsync(WeaviateEndpoints.ReplicationDelete(id));
    ...
    /// </summary>
    internal async Task DeleteAllReplicationsAsync()
    {
        var response = await _httpClient.DeleteAsync(WeaviateEndpoints.Replicate());
