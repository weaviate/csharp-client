...
public static class GenerativeConfig
{
    ...
    /// <summary>
    /// Configuration for DigitalOcean generative AI provider.
    /// </summary>
    public record DigitalOcean : IGenerativeConfig
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DigitalOcean"/> class.
        /// </summary>
        [JsonConstructor]
        internal DigitalOcean() { }

        /// <summary>
        /// The type value for DigitalOcean configuration.
        /// </summary>
        public const string TypeValue = "generative-digitalocean";
        ...
        /// <summary>
        /// Gets or sets the base URL for the DigitalOcean API endpoint.
        /// </summary>
        public string? BaseURL { get; set; }
