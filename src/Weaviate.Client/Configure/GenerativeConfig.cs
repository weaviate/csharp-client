...
#pragma warning disable CA1822 // Mark members as static
    ...
    /// <summary>
    /// Create a generative configuration for DigitalOcean.
    /// </summary>
    /// <param name="model">The model to use.</param>
    /// <param name="temperature">The temperature.</param>
    /// <param name="maxTokens">The maximum number of tokens to generate.</param>
    ...
    /// <param name="stop">The stop sequences.</param>
    /// <returns>A <see cref="IGenerativeConfig"/> instance.</returns>
    public IGenerativeConfig DigitalOcean(
        string? model = null,
        double? temperature = null,
        int? maxTokens = null,
        double? frequencyPenalty = null,
        ...
        new GenerativeConfig.DigitalOcean
        {
            Model = model,
            Temperature = temperature,
            MaxTokens = maxTokens,
    ...
    /// <summary>
    /// Create a generative configuration for Meta.
    /// </summary>
    /// <param name="model">The model to use.</param>
    /// <param name="temperature">The temperature.</param>
    /// <param name="maxTokens">The maximum number of tokens to generate.</param>
