...
#pragma warning disable CA1822 // Mark members as static
    ...
    /// <summary>
    /// Creates a DigitalOcean runtime provider configuration.
    /// </summary>
    /// <param name="baseUrl">The base url</param>
    /// <param name="model">The model</param>
    /// <param name="temperature">The temperature</param>
    ...
    /// <param name="topP">The top</param>
    /// <param name="stop">The stop</param>
    /// <returns>The providers digital ocean</returns>
    public Providers.DigitalOcean DigitalOcean(
        string? baseUrl = null,
        string? model = null,
        double? temperature = null,
        long? maxTokens = null,
    ...
    /// <summary>
    /// Creates a Meta runtime provider configuration.
    /// </summary>
    /// <param name="baseUrl">The base url</param>
    /// <param name="model">The model</param>
    /// <param name="temperature">The temperature</param>
    ...
    /// <param name="topP">The top</param>
    /// <param name="reasoningEffort">The reasoning effort</param>
    /// <returns>The providers meta</returns>
    public Providers.Meta Meta(
        string? baseUrl = null,
        string? model = null,
        double? temperature = null,
        long? maxTokens = null,
        ...
        double? presencePenalty = null,
        double? topP = null,
        Providers.Meta.ReasoningEffortLevel? reasoningEffort = null
    ) =>
        new()
        {
            BaseUrl = baseUrl,
